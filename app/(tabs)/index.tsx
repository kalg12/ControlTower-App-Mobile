...
// Handles UP, DOWN, DEGRADED (real API) + HEALTHY, CRITICAL, UNKNOWN (fallbacks)
  ...
  return (
    ...
    >
      ...
      <View className="p-4 gap-3">
          ...
          <>
            ...
            <View className="flex-row gap-3">
              <MiniStat
                ...
                iconColor="#A78BFA"
                label="Clientes"
                value={String(dash.totalClients)}
              />
              <MiniStat
                icon="storefront-outline"
                iconColor="#60A5FA"
                label="Sucursales"
                value={`${dash.branchesUp}/${dash.activeBranches}`}
                sub="activas"
              />
              <MiniStat
                ...
                iconColor="#EF4444"
                label="Incidentes"
                value={String(dash.openIncidents)}
                alert={dash.openIncidents > 0}
              />
            </View>
        ...
        <View className="flex-row gap-3">
          <QuickAction icon="mail-outline" label="Abiertos" color="#60A5FA"
            onPress={() => goToTickets("OPEN")} />
...
function StatCard({
  label, value, color, bg, border, icon, iconColor, onPress,
}: {
